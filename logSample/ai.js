        ...
        var o = function() {
            ...
            return o.throwInternal = function(e, t, o, a, r) {
                ...
                if (!this._areInternalMessagesThrottled()) {
                    ...
                    if (e.Util.canUseSessionStorage() ? e.Util.getSessionStorage(l) ? s = !1 : e.Util.setSessionStorage(l, "1") : this._messageLogged[l] ? s = !1 : this._messageLogged[l] = !0, s && ((this.verboseLogging() || a === t.CRITICAL) 
                    && (this.queue.push(r), this._messageCount++), this._messageCount == this.MAX_INTERNAL_MESSAGE_LIMIT)) {
...
! function(e) {
    ! function(e) {
        ...
        var n = function() {
            ...
            }, n.document = "undefined" != typeof document ? document : {}, n._canUseCookies = undefined, n._canUseLocalStorage = undefined, n._canUseSessionStorage = undefined, n.NotSpecified = "not_specified", n
        }();
        e.Util = n;
        var i = function() {
            function e() {}
            ...
            return n.serialize = function(e) {
                ...
                if (!i.aiDataContract) {
                    if ("measurements" === o) a = n._serializeStringMap(i, "number", o);
                        ...
                        try {
                            ...
                            e._InternalLogging.throwInternal(e.LoggingSeverity.CRITICAL, e._InternalMessageId.CannotSerializeObject, d && "function" == typeof d.toString ? d.toString() : "Error serializing object", null, !0)
                        }
                    }
                    return a
                }
                ...
                for (var r in i.aiDataContract) {
                    ...
                    if (!l || g || u) {
                        if (!c) {
                            var f;
                            (f = p ? u ? n._serializeArray(i[r], r) : n._serializeObject(i[r], r) : i[r]) !== undefined && (a[r] = f)
                        }
...
! function(e) {
    ! function(t) {
        var n = function() {
            function n(e) {
                this.currentWindowHost = window.location ? window.location.host : {}, this.appInsights = e, this.initialized = !1, this.Init()
            }
            return n.prototype.Init = function() {
                ...
                var a = new t.ajaxRecord(t.Util.newId());
                a.method = n, a.requestUrl = i, a.xhrMonitoringState.openDone = !0, e.ajaxData = a, this.attachToOnReadyStateChange(e)
                ...
                }) : (this.appInsights.trackDependency(e.ajaxData.id, e.ajaxData.method, e.ajaxData.getAbsoluteUrl(), e.ajaxData.getPathName(), e.ajaxData.ajaxTotalDuration, +e.ajaxData.status >= 200 && +e.ajaxData.status < 400, +e.ajaxData.status), e.ajaxData = null)
    ...
    ! function(e) {
        var t = function() {
            ...
            return t.prototype.send = function(t) {
                ...
                o[e.AjaxMonitor.DisabledPropertyName] = !0, o.open("POST", this._config.endpointUrl(), n), o.setRequestHeader("Content-type", "application/json"), o.onreadystatechange = function() {
                ...
                if (4 === t.readyState)
                    ...
                    var o = this._parseResponse(t.responseText || t.response);
                    o && !this._config.isRetryDisabled() ? this._onPartialSuccess(n, o) : this._onError(n, this._formatErrorMessageXhr(t))
            ...
            ! function(t) {
                var n = function() {
                    ...
                    return t.sanitizeKeyAndAddUniqueness = function(e, n) {
                        ...
                        return n && (n = e.Util.trim(n)).toString().length > t.MAX_STRING_LENGTH && (n = n.toString().substring(0, t.MAX_STRING_LENGTH), e._InternalLogging.throwInternal(e.LoggingSeverity.WARNING, e._InternalMessageId.StringValueTooLong, "string value is too long. It has been truncated to " + t.MAX_STRING_LENGTH + " characters.", {
                            value: n
                        }, !0)), n
                    }, t.sanitizeUrl = function(n) {
                        return n && (n = e.Util.trim(n)).length > t.MAX_URL_LENGTH && (n = n.substring(0, t.MAX_URL_LENGTH), e._InternalLogging.throwInternal(e.LoggingSeverity.WARNING, e._InternalMessageId.UrlTooLong, "url is too long, it has been truncated to " + t.MAX_URL_LENGTH + " characters.", {
                            url: n
                        }, !0)), n
            ...
            var i = function(n) {
                    ...
                    return __extends(i, n), i.prototype.parseStack = function(e) {
                        ...
                        if ("string" == typeof e) {
                            ...
                            if (a > 32768)
                                for (var c = 0, u = t.length - 1, g = 0, p = c, f = u; c < u;) {
...
! function(e) {
    ! function(e) {
        ! function(t) {
            var n = function(n) {
                function i(i, o, a, r, s) {
                    var l = n.call(this) || this;
                    return l.aiDataContract = {
                        ver: e.FieldType.Required,
                        ...
                        properties: e.FieldType.Default,
                        measurements: e.FieldType.Default
                    }, l.url = t.Common.DataSanitizer.sanitizeUrl(o), l.name = t.Common.DataSanitizer.sanitizeString(i) || e.Util.NotSpecified, isNaN(a) || (l.duration = e.Util.msToTimeSpan(a)), l.properties = e.Telemetry.Common.DataSanitizer.sanitizeProperties(r), l.measurements = e.Telemetry.Common.DataSanitizer.sanitizeMeasurements(s), l
                }
                ...
                function i(o, a, r, s, l) {
                    ...
                    if (u) {
                        var g = i.getDuration(u.navigationStart, u.loadEventEnd),
                            ...
                            f = i.getDuration(u.requestStart, u.responseStart),
                            d = i.getDuration(u.responseStart, u.responseEnd),
                        ...
                        0 == g ? e._InternalLogging.throwInternal(e.LoggingSeverity.WARNING, e._InternalMessageId.ErrorPVCalc, "error calculating page view performance.", {
                            ...
                            response: d,
                            dom: h
                        }) : i.shouldCollectDuration(g, p, f, d, h) ? g < Math.floor(p) + Math.floor(f) + Math.floor(d) + Math.floor(h) ? e._InternalLogging.throwInternal(e.LoggingSeverity.WARNING, e._InternalMessageId.ClientPerformanceMathError, "client performance math error.", {
                            total: g,
                            network: p,
                            request: f,
                            response: d,
                            dom: h
                        }) : (c.durationMs = g, c.perfTotal = c.duration = e.Util.msToTimeSpan(g), c.networkConnect = e.Util.msToTimeSpan(p), c.sentRequest = e.Util.msToTimeSpan(f), c.receivedResponse = e.Util.msToTimeSpan(d), c.domProcessing = e.Util.msToTimeSpan(h), c.isValid = !0) : e._InternalLogging.throwInternal(e.LoggingSeverity.WARNING, e._InternalMessageId.InvalidDurationValue, "Invalid page load duration value. Browser perf data won't be sent.", {
                            total: g,
                            network: p,
                            request: f,
                            response: d,
            ...
            var n = function(n) {
                function i(i, o, a, r, s, l, c, u, g) {
                    ...
                    if (p.aiDataContract = {
                        ...
                        }, p.id = i, p.duration = e.Util.msToTimeSpan(r), p.success = s, p.resultCode = l + "", p.type = "Ajax", p.data = t.Common.DataSanitizer.sanitizeUrl(a), o && o.length > 0) {
                        var f = e.UrlHelper.parseUrl(o);
                        if (p.target = f.host, null != f.pathname) {
                            var d = 0 === f.pathname.length ? "/" : f.pathname;
                            "/" !== d.charAt(0) && (d = "/" + d), p.name = t.Common.DataSanitizer.sanitizeString(c ? c + " " + d : d)
                        } else p.name = t.Common.DataSanitizer.sanitizeString(o)
                    } else p.target = a, p.name = a;
                    return p.properties = e.Telemetry.Common.DataSanitizer.sanitizeProperties(u), p.measurements = e.Telemetry.Common.DataSanitizer.sanitizeMeasurements(g), p
                }
    ...
    ! function(t) {
        ...
        var n = function() {
            ...
            return n.prototype.sendPageViewInternal = function(e, n, i, o, a) {
                var r = new t.Telemetry.PageView(e, n, i, o, a),
